...
This is a sample template for aws-layers-demo - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name aws-layers-demo --tail
```
...
```bash
aws cloudformation delete-stack --stack-name aws-layers-demo
```
